...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="flex items-center justify-center w-7 h-7 rounded border border-border/40 hover:border-border-strong hover:bg-surface-alt/50 transition-colors cursor-pointer"
